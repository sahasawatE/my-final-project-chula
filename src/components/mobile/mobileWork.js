    ...
    if (user.Teacher_id) {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                {selectSubject ?
                    <Button onClick={() => { setModalCreateWork(true); setOpen(false) }} style={{ color: '#4377ED' }}>สร้างงาน</Button>
                    :
                ...
                <div>
                    <Modal centered backdropClassName="modal" backdrop="static" show={deleteModal}>
                        ...
                        <Modal.Footer style={{ display: 'flex', justifyContent: 'space-around' }}>
                            <Button variant="outlined" onClick={() => {setDeleteModal(false); setOpen(true)}}>ยกเลิก</Button>
