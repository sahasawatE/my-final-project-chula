...
export default function MobileThread() {
    ...
    const {setOpen, setOpenThread} = react.useContext(toggleContext);
                ...
                <div>
                    <Grid container justifyContent="center">
                        <Button onClick={() => {
                            ...
                            setOpen(false);
                            setOpenThread(false);
                        }} style={{ width: '100%' }} color="primary">สร้างกระทู้พูดคุยกับครูและเพื่อน ๆ</Button>
                        {thread.length === 0 ?
                        ...
                        <div>
                            <Modal centered backdropClassName="modal" show={showThread} backdrop="static" size="lg" aria-labelledby="contained-modal-title-vcenter" onHide={() => {
                                ...
                                <Modal.Body style={{ display: 'flex' }}>
                                    <Grid container direction="row" style={{ maxHeight: '73vh', height: '100%' }}>
                                        <Grid item xs={12} style={{width:'100%',height:'30vh'}}>
                                        ...
                                        <Grid item xs={12} style={{ width: '100%', height: '40vh' }}>
                                            <Typography>คำตอบ</Typography>
                                            <div style={{ height: '26vh', overflow: 'scroll' }} ref={commentSection}>
                                                {reply || replyMsg ?
