...
import MobileStudentDocument from './mobileStudentDocument';
...
export default function MobileDocuments(props) {
        ...
        if (role === 'teacher') {
            return (
                <Grid container justifyContent='center' direction='column'>
                    <Button variant='text' style={{ width: '100%', color: '#4377ED' }} onClick={() => { 
            ...
            return (
                <div className='pdf-container'>
                    <MobileStudentDocument subject={props.subject} user={props.user} />
                </div>
            )
        }
    }
